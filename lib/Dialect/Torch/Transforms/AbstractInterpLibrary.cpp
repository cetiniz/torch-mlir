...
"    %1 = torch.aten.remainder.int %0, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"    %2 = torch.aten.eq.int %1, %int0 : !torch.int, !torch.int -> !torch.bool\n"
"    %3 = torch.prim.If %2 -> (!torch.list<list<int>>) {\n"
"      %4 = torch.aten.__getitem__.t %arg0, %arg2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %5 = torch.aten.floordiv.int %4, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"      %6 = torch.prim.ListConstruct  : () -> !torch.list<list<int>>\n"
"      torch.prim.Loop %5, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %7 = torch.aten.slice.t %arg0, %none, %arg2, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"        %8 = torch.prim.ListConstruct %arg1 : (!torch.int) -> !torch.list<int>\n"
"        %9 = torch.aten.add.t %7, %8 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"        %10 = torch.aten.add.int %arg2, %int1 : !torch.int, !torch.int -> !torch.int\n"
...
"        %13 = torch.aten.append.t %6, %12 : !torch.list<list<int>>, !torch.list<int> -> !torch.list<list<int>>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      torch.prim.If.yield %6 : !torch.list<list<int>>\n"
"    } else {\n"
"      %4 = torch.aten.__getitem__.t %arg0, %arg2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %5 = torch.aten.floordiv.int %4, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"      %6 = torch.aten.__getitem__.t %arg0, %arg2 : !torch.list<int>, !torch.int -> !torch.int\n"
"      %7 = torch.aten.mul.int %5, %arg1 : !torch.int, !torch.int -> !torch.int\n"
"      %8 = torch.aten.sub.int %6, %7 : !torch.int, !torch.int -> !torch.int\n"
"      %9 = torch.prim.ListConstruct  : () -> !torch.list<list<int>>\n"
"      torch.prim.Loop %5, %true, init() {\n"
"      ^bb0(%arg3: !torch.int):\n"
"        %17 = torch.aten.slice.t %arg0, %none, %arg2, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"        %18 = torch.prim.ListConstruct %arg1 : (!torch.int) -> !torch.list<int>\n"
"        %19 = torch.aten.add.t %17, %18 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"        %20 = torch.aten.add.int %arg2, %int1 : !torch.int, !torch.int -> !torch.int\n"
"        %21 = torch.aten.slice.t %arg0, %20, %none, %int1 : !torch.list<int>, !torch.int, !torch.none, !torch.int -> !torch.list<int>\n"
"        %22 = torch.aten.add.t %19, %21 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"        %23 = torch.aten.append.t %9, %22 : !torch.list<list<int>>, !torch.list<int> -> !torch.list<list<int>>\n"
"        torch.prim.Loop.condition %true, iter()\n"
"      } : (!torch.int, !torch.bool) -> ()\n"
"      %10 = torch.aten.slice.t %arg0, %none, %arg2, %int1 : !torch.list<int>, !torch.none, !torch.int, !torch.int -> !torch.list<int>\n"
"      %11 = torch.prim.ListConstruct %8 : (!torch.int) -> !torch.list<int>\n"
"      %12 = torch.aten.add.t %10, %11 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"      %13 = torch.aten.add.int %arg2, %int1 : !torch.int, !torch.int -> !torch.int\n"
"      %14 = torch.aten.slice.t %arg0, %13, %none, %int1 : !torch.list<int>, !torch.int, !torch.none, !torch.int -> !torch.list<int>\n"
"      %15 = torch.aten.add.t %12, %14 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"      %16 = torch.aten.append.t %9, %15 : !torch.list<list<int>>, !torch.list<int> -> !torch.list<list<int>>\n"
"      torch.prim.If.yield %9 : !torch.list<list<int>>\n"
"    }\n"
